...
private class DeviceDescriptionHandler : DefaultHandler() {
    ...
    fun result(locationUrl: String): DlnaDevice? {
        val name = friendlyName?.ifBlank { null } ?: return null
        val rawControlUrl = avTransportControlUrl?.ifBlank { null } ?: return null
        val resolvedControlUrl = DeviceDescriptionParser.resolveControlUrl(locationUrl, rawControlUrl) ?: return null
        return DlnaDevice(friendlyName = name, controlUrl = resolvedControlUrl)
    }
